...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative py-16 bg-gray-50 w-full" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-2 sm:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 bg-gradient-to-br from-blue-700 to-blue-400 rounded-xl shadow-lg overflow-hidden">
          {/* Contact Info */}
          <div className="col-span-1 bg-white/10 text-white p-8 flex flex-col gap-6 min-w-[220px]">
            ...
            <div className="flex items-start gap-4 border-b border-white/20 pb-4">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm">+91-9444042142</p>              </div>
            </div>
            <div className="flex items-start gap-4 border-b border-white/20 pb-4">
              <div className="w-9 h-9 flex items-center justify-center bg-blue-800/20 rounded-full mt-1">
