...
const Hero: React.FC = () => {
  ...
  return (
    <section
      className="relative flex items-center justify-center text-white h-screen min-h-[600px] bg-cover bg-center bg-fixed mt-[-120px] pt-[120px] overflow-hidden w-full"
      style={{ backgroundImage: "url('https://files.catbox.moe/kihwl8.jpg')" }}
      ref={heroRef}
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/80 to-teal-900/80 z-10"></div>
      <div className="relative z-20 text-center w-full max-w-xs xs:max-w-md sm:max-w-lg md:max-w-2xl flex flex-col justify-center items-center h-full px-2 sm:px-4">
